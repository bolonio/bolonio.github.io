...
![three wrongly built accessible ramps](./wrong-a11y.jpeg)
...
But it's very clear to me that these three situations are definetely wrongly done, and a person using a wheelchair will always have problems using these three "accessible" ramps.
...
The problem here is that for visually impaired people such as blind people, there's no such as thing as top right corner or button with the engine icon.
...
![A slide of a presentation on how to use the tool react-axe](./react-axe.jpeg)
...
![A slide of a presentation on how to use the tool eslint-plugin-jsx-a11y](./eslint-plugin-jsx-a11y.jpeg)
...
![A slide of a presentation on how to use the tool jest-axe](./jest-axe.jpeg)
...
![A slide of a presentation on how to use the tool axe-cli](./axe-cli.jpeg)
...
![A slide of a presentation on how to use the tool pa11y](./pa11y.jpeg)
...
![A slide of a presentation on how to use the tool pa11yci](./pa11yci.jpeg)
...
![A slide of a presentation on how to use the tool lighthouse](./lighthouse.jpeg)
...
![A slide of a presentation on how to use the tool axe chrome extension](./axe-chrome.jpeg)
...
![A slide of a presentation on how to use the tool ARC toolkit](./arc-chrome.jpeg)
...
![A slide of a presentation on how to use the tool accessibility insights](./accessibility-insights.jpeg)
...
![A slide of a presentation on how to use the tool WAVE chrome extension](./wave-chrome.jpeg)
...
![A slide of a presentation on how to use the tool NoCoffee](./nocoffee-chrome.jpeg)
...
![A quote that says "accessibility is not a feature"](./a11y-is-not-a-feature.jpeg)
